...
namespace std {
  template <typename T>
  struct less<ospcommon::math::vec_t<T, 2>>
  {
    inline bool operator()(const ospcommon::math::vec_t<T, 2> &a,
                           const ospcommon::math::vec_t<T, 2> &b) const
    {
  ...
  template <typename T, bool A>
  struct less<ospcommon::math::vec_t<T, 3, A>>
  {
    inline bool operator()(const ospcommon::math::vec_t<T, 3, A> &a,
                           const ospcommon::math::vec_t<T, 3, A> &b) const
    {
      return (a.x < b.x) ||
  ...
  template <typename T>
  struct less<ospcommon::math::vec_t<T, 4>>
  {
    inline bool operator()(const ospcommon::math::vec_t<T, 4> &a,
                           const ospcommon::math::vec_t<T, 4> &b) const
    {
      return (a.x < b.x) ||
             ((a.x == b.x) &&
              ((a.y < b.y) ||
