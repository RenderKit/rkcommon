...
namespace rkcommon {
  namespace math {
    ...
    struct LinearSpace2
    {
      ...
      inline LinearSpace2(const LinearSpace2 &other)
      {
        vx = other.vx;
        vy = other.vy;
      }
      inline LinearSpace2 &operator=(const LinearSpace2 &other)
      {
        vx = other.vx;
        vy = other.vy;
        return *this;
      ...
      inline LinearSpace2(const LinearSpace2<L1> &s) : vx(s.vx), vy(s.vy)
      {
      }

      /*! matrix construction from column vectors */
      inline LinearSpace2(const Vector &vx, const Vector &vy) : vx(vx), vy(vy)
      {
      }

      /*! matrix construction from row mayor data */
      inline LinearSpace2(const Scalar &m00,
                          const Scalar &m01,
                          const Scalar &m10,
                          const Scalar &m11)
      ...
      inline const Scalar det() const
      {
        return vx.x * vy.y - vx.y * vy.x;
      }

      /*! compute adjoint matrix */
      inline const LinearSpace2 adjoint() const
      {
        return LinearSpace2(vy.y, -vy.x, -vx.y, vx.x);
      }

      /*! compute inverse matrix */
      inline const LinearSpace2 inverse() const
      {
        return adjoint() / det();
      }

      /*! compute transposed matrix */
      inline const LinearSpace2 transposed() const
      {
        return LinearSpace2(vx.x, vx.y, vy.x, vy.y);
      }

      /*! returns first row of matrix */
      inline const Vector row0() const
      {
        return Vector(vx.x, vy.x);
      }

      /*! returns second row of matrix */
      inline const Vector row1() const
      {
        return Vector(vx.y, vy.y);
      }
      ...
      {
        return LinearSpace2(s.x, 0, 0, s.y);
      }
      ...
      static inline LinearSpace2 rotate(const Scalar &r)
      {
        ...
        return LinearSpace2(c, -s, s, c);
      }

      /*! return closest orthogonal matrix (i.e. a general rotation including
       * reflection) */
    ...
    template <typename T>
    inline LinearSpace2<T> operator-(const LinearSpace2<T> &a)
    {
    ...
    template <typename T>
    inline LinearSpace2<T> rcp(const LinearSpace2<T> &a)
    {
      return a.inverse();
    }
    ...
    template <typename T>
    inline LinearSpace2<T> operator*(const typename T::Scalar &a,
                                     const LinearSpace2<T> &b)
    {
      return LinearSpace2<T>(a * b.vx, a * b.vy);
    }
    template <typename T>
    inline T operator*(const LinearSpace2<T> &a, const T &b)
    {
    ...
    template <typename T>
    inline LinearSpace2<T> &operator*=(LinearSpace2<T> &a,
                                       const LinearSpace2<T> &b)
    {
      return a = a * b;
    }
    ...
    struct LinearSpace3
    {
      ...
      inline LinearSpace3(const LinearSpace3 &other)
      {
        vx = other.vx;
        vy = other.vy;
        vz = other.vz;
      }
      inline LinearSpace3 &operator=(const LinearSpace3 &other)
      {
        vx = other.vx;
        vy = other.vy;
        vz = other.vz;
      ...
      template <typename L1>
      inline LinearSpace3(const LinearSpace3<L1> &s)
      ...
      /*! matrix construction from row mayor data */
      inline LinearSpace3(const Scalar &m00,
                          const Scalar &m01,
                          const Scalar &m02,
                          const Scalar &m10,
                          const Scalar &m11,
      ...
      /*! compute adjoint matrix */
      inline const LinearSpace3 adjoint() const
      {
        return LinearSpace3(cross(vy, vz), cross(vz, vx), cross(vx, vy))
            .transposed();
      }

      /*! compute inverse matrix */
      inline const LinearSpace3 inverse() const
      {
        return adjoint() / det();
      }

      /*! compute transposed matrix */
      inline const LinearSpace3 transposed() const
      {
        return LinearSpace3(
      ...
      inline const Vector row0() const
      {
        return Vector(vx.x, vy.x, vz.x);
      }

      /*! returns second row of matrix */
      inline const Vector row1() const
      {
        return Vector(vx.y, vy.y, vz.y);
      }

      /*! returns third row of matrix */
      inline const Vector row2() const
      {
        return Vector(vx.z, vy.z, vz.z);
      }
      ...
      inline LinearSpace3(OneTy)
          : vx(one, zero, zero), vy(zero, one, zero), vz(zero, zero, one)
      {
      }
      ...
      {
        return LinearSpace3(s.x, 0, 0, 0, s.y, 0, 0, 0, s.z);
      }
      ...
      static inline LinearSpace3 rotate(const Vector &_u, const Scalar &r)
      {
        ...
        Scalar s = sin(r), c = cos(r);
        return LinearSpace3(u.x * u.x + (1 - u.x * u.x) * c,
                            u.x * u.y * (1 - c) - u.z * s,
                            u.x * u.z * (1 - c) + u.y * s,
                            u.x * u.y * (1 - c) + u.z * s,
                            u.y * u.y + (1 - u.y * u.y) * c,
    ...
    template <typename T>
    inline LinearSpace3<T> operator-(const LinearSpace3<T> &a)
    {
    ...
    template <typename T>
    inline LinearSpace3<T> rcp(const LinearSpace3<T> &a)
    {
      return a.inverse();
    }
    ...
    template <typename T>
    inline LinearSpace3<T> clamp(const LinearSpace3<T> &space)
    {
    ...
    template <typename T>
    inline LinearSpace3<T> operator*(const typename T::Scalar &a,
                                     const LinearSpace3<T> &b)
    {
      return LinearSpace3<T>(a * b.vx, a * b.vy, a * b.vz);
    }
    template <typename T>
    inline T operator*(const LinearSpace3<T> &a, const T &b)
    {
    ...
    template <typename T>
    inline T xfmPoint(const LinearSpace3<T> &s, const T &a)
    {
      return madd(T(a.x), s.vx, madd(T(a.y), s.vy, T(a.z * s.vz)));
    }
    template <typename T>
    inline T xfmVector(const LinearSpace3<T> &s, const T &a)
    {
      return madd(T(a.x), s.vx, madd(T(a.y), s.vy, T(a.z * s.vz)));
    }
    template <typename T>
    inline T xfmNormal(const LinearSpace3<T> &s, const T &a)
    {
