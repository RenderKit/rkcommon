...
macro(ospcommon_create_tasking_target FROM_INSTALL)
  ...
  if(OSPCOMMON_TASKING_TBB)
    if (FROM_INSTALL)
      ...
      if (NOT OSPCOMMON_TBB_ROOT STREQUAL "")
        set(TBB_ROOT ${OSPCOMMON_TBB_ROOT})
      endif()
      find_package(TBB 4.4 REQUIRED tbb tbbmalloc)
    endif()

    if (TBB_FOUND)
      list(APPEND OSPCOMMON_TASKING_LIBS TBB)
